...
<body>
    ...
    <c:choose>
        <c:when test="${param.type eq 'edit'}">
            <c:set var="action" value="editUserConfirm.web?ssid=${ssid}&type=edit" />
        </c:when>
        <c:otherwise>
            <c:set var="action" value="addUserOK.web?ssid=${ssid}&type=add" />
        </c:otherwise>
    </c:choose>
                    ...
                    <div id="mstJapan" style="padding-left: 100px; display: none">
                        <table border="1" width="70%" class="tbl_input" cellpadding="4"
                            ...
                            <tr>
                                ...
                                <td align="left"><c:if
                                        test="${userInfor.codeLevel ne 'N0'}">
                                        <c:out value="${userInfor.startDateString}" escapeXml="true" />
                                    </c:if></td>
                            </tr>
                            <tr>
                                ...
                                <td align="left"><c:if
                                        test="${userInfor.codeLevel ne 'N0'}">
                                        <c:out value="${userInfor.endDateString}" escapeXml="true" />
                                    </c:if></td>
                            </tr>
                            <tr>
        ...
        <div style="padding-left: 45px;">
            <table border="0" cellpadding="4" cellspacing="0" width="300px">
                <tr>
                    ...
                    <c:set var="url" value="addUserInput.web?ssid=${ssid}&type=back" />
